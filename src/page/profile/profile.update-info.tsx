...
import { AvatarField } from 'page/user/user-create/user-create.avatar';
import { BirthdayField } from 'page/user/user-create/user-create.birthday';
import { InputField } from 'page/user/user-create/user-create.input-field';
import { SelectTypeField } from 'page/user/user-create/user-create.select-type';
import { StatusField } from 'page/user/user-create/user-create.status';
import { createUserSchema, initialValues } from 'page/user/user-create/user-create.types';
